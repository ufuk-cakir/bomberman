...
class HYPER:
    ...
    EPS_START     = 0.99# 0.9 # Epsilon greedy policy if agents converges to suboptimal policy, increase. If agent is too random, decrease
    ...
    MODEL_NAME = "coin_collector_deeper.pt"
